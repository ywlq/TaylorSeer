...
def fm_wrapper(transformer, t_scale=1000.0):
    def k_model(x, sigma, **extra_args):
        ...
        cache_dic = extra_args['cache_dic']
        current = extra_args['current']
        ...
        pred_positive = transformer(hidden_states=hidden_states, timestep=timestep, return_dict=False, cache_dic=cache_dic, current=current, **extra_args['positive'])[0].float()
