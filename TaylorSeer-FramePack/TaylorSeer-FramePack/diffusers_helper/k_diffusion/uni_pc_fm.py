...
class FlowMatchUniPC:
    ...
    def sample(self, x, sigmas, callback=None, disable_pbar=False, cache_dic=None, current=None):
        order = min(3, len(sigmas) - 2)

        # if cache_dic is None or current is None:
        #     cache_dic, current = cache_init(num_steps=len(sigmas)-1)
...
def sample_unipc(model, noise, sigmas, extra_args=None, callback=None, disable=False, variant='bh1', cache_dic=None, current=None):
